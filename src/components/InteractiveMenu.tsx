            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`shrink-0 rounded-full px-7 py-3 font-sans text-sm sm:text-base font-bold tracking-wide transition-all duration-150 border border-[#dbe1e3] ${isActive
